...
public class AdapterProdukPembelian extends RecyclerView.Adapter<AdapterProdukPembelian.ViewHolder> {
    private Context context;
    private ArrayList<ListProduk> listProduk;
    private static ProdukOnClick produkOnClick;

    SqliteHelper sqliteHelper;

    public AdapterProdukPembelian(Context context, ArrayList<ListProduk> listProduk) {
    ...
    public interface ProdukOnClick{
        void onClick(View v, int position);
    }

    public void setOnItemClickListener(ProdukOnClick produkOnClick){
        AdapterProdukPembelian.produkOnClick   = produkOnClick;
    }
